...
using Microsoft.ML.Trainers;
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Murav\Documents\WorldOfZuul\Language Model\dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Assessment",inputColumnName:@"Assessment",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Assessment", sentence1ColumnName: @"Statement"))      
