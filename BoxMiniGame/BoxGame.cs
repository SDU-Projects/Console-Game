...
public class BoxGame : IMinigame
{
    private string _returnKeyword;
    public BoxGame(string word)
    {
        _returnKeyword = word;
    }

    public void PrintBox(int number,string ans1, string ans2)
    {
        Console.WriteLine("┌───────────────┐");
    ...
    public MinigameResult Play()
    {
        ...
        while (a1 != "2000")
        {
            ...
            Console.WriteLine("THE BOX GAME");
            PrintBox(1700, ans1, ans2);
            PrintBox(1800, ans3, ans4);
            PrintBox(1900, ans5, ans6);
            PrintBox(2000, ans7, ans8);
        ...
        return MinigameResult.Victory(_returnKeyword);
    }
}